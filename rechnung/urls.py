...
urlpatterns = [
    ...
    url(
        r"^(?P<rechnung_id>[0-9]+)/aendern/$",
        views.form_rechnung,
        name="rechnung_aendern",
    ),
    # ex: /rechnung/5/duplizieren
    url(
        r"^(?P<rechnung_id>[0-9]+)/duplizieren/$",
        views.duplicate_rechnung,
        name="rechnung_duplizieren",
    ),
    # ex: /rechnung/5/posten/neu
    url(
        r"^(?P<rechnung_id>[0-9]+)/posten/neu/$",
        views.form_rechnung_posten,
        name="rechnung_posten_neu",
    ),
    # ex: /rechnung/5/pdf
    url(
        r"^(?P<rechnung_id>[0-9]+)/pdf/$",
        views.rechnungpdf,
        name="rechnungpdf",
    ),
    # ex: /rechnung/suchen
    ...
    url(
        r"^(?P<rechnung_id>[0-9]+)/mahnung/(?P<mahnung_id>[0-9]+)/$",
        views.mahnung,
        name="mahnung",
    ),
    ...
    url(
        r"^(?P<rechnung_id>[0-9]+)/mahnung/neu/$",
        views.form_mahnung,
        name="mahnung_neu",
    ),
    # ex: /rechnung/5/mahnung/2/aendern
    url(
        r"^(?P<rechnung_id>[0-9]+)/mahnung/(?P<mahnung_id>[0-9]+)/aendern/$",
        views.form_mahnung,
        name="mahnung_aendern",
    ),
    # ex: /rechnung/5/mahnung/2/pdf
    url(
        r"^(?P<rechnung_id>[0-9]+)/mahnung/(?P<mahnung_id>[0-9]+)/pdf/$",
        views.rechnungpdf,
        name="mahnungpdf",
    ),
    # Kunde##############################################################
    ...
    url(
        r"^kunde/(?P<kunde_id>[0-9]+)/aendern/$",
        views.form_kunde,
        name="kunde_aendern",
    ),
    ...
    url(
        r"^posten/(?P<posten_id>[0-9]+)/aendern/$",
        views.form_exist_posten,
        name="posten_aendern",
    ),
    # Kategorie##########################################################
    ...
    url(
        r"^kategorie/(?P<kategorie_id>[0-9]+)/$",
        views.kategorie_detail,
