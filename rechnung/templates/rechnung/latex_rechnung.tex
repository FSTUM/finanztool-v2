{% autoescape off %}
    ...
    \notblank{ {{ rechnung.kunde.vorname | latexescape }}{{ rechnung.kunde.name | latexescape }} }
        { {{ rechnung.kunde.titel | latexescape }} {{ rechnung.kunde.vorname | latexescape }} {{ rechnung.kunde.name | latexescape }}  \\[0.2ex]}{}
    ...
    \ifnum\pdfstrcmp{ {{ rechnung.kunde.anrede | latexescape }} }{ w }=0
        Sehr geehrte Frau {{ rechnung.kunde.titel | latexescape }} {{ rechnung.kunde.name | latexescape }},\\[2ex]
    \else
        \ifnum\pdfstrcmp{ {{ rechnung.kunde.anrede | latexescape }} }{ m }=0
            Sehr geehrter Herr {{ rechnung.kunde.titel | latexescape }} {{ rechnung.kunde.name | latexescape }},\\[2ex]
        \else
