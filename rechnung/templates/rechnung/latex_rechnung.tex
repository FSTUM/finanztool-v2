{% autoescape off %}
    ...
    \notblank{ {{ rechnung.kunde.organisation|default_if_none:"" | latexescape }} }
        { {{ rechnung.kunde.organisation | latexescape }}\\[0.5ex]}{}
    \notblank{ {{ rechnung.kunde.suborganisation|default_if_none:"" | latexescape }} }
        { {{ rechnung.kunde.suborganisation | latexescape }} \\[0.2ex]}{}
    \notblank{ {{ rechnung.kunde.name|default_if_none:"" | latexescape }} }
