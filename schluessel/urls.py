...
urlpatterns = [
    ...
    url(
        r"^changes/list/$",
        views.list_key_changes,
        name="list_key_changes",
    ),
    url(
        r"^changes/apply/$",
        views.apply_key_change,
        name="apply_key_change",
    ),
    url(
        r"^changes/apply/(?P<key_pk>[0-9]+)/$",
        views.apply_key_change,
        name="apply_key_change",
    ),
    url(
        r"^changes/save/(?P<key_pk>[0-9]+)/$",
        views.save_key_change,
        name="save_key_change",
    ),
    url(
        r"^changes/del/(?P<key_pk>[0-9]+)/$",
        views.delete_key_change,
    ...
    url(
        r"^(?P<key_pk>[0-9]+)/give/addperson/$",
        views.give_add_person,
        name="give_add_person",
    ),
    url(
        r"^(?P<key_pk>[0-9]+)/give/editperson/(?P<person_pk>[0-9]+)/$",
        views.give_edit_person,
        name="give_edit_person",
    ),
    url(
        r"^(?P<key_pk>[0-9]+)/give/confirm/(?P<person_pk>[0-9]+)/$",
        views.give_key_confirm,
        name="give_key_confirm",
    ),
    url(
        r"^(?P<key_pk>[0-9]+)/kaution/$",
        views.get_kaution,
        name="get_kaution",
    ),
    url(
        r"^(?P<key_pk>[0-9]+)/quittung/$",
        views.get_quittung,
        name="get_quittung",
    ),
    ...
    url(
        r"^person/(?P<person_pk>[0-9]+)/$",
        views.view_person,
        name="view_person",
    ),
    url(
        r"^person/(?P<person_pk>[0-9]+)/edit/$",
        views.edit_person,
        name="edit_person",
    ),
]
